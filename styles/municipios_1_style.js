...
var style_municipios_1 = function(feature, resolution){
    ...
    var value = feature.get("pob x km2");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 70.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 70.000000 && value <= 261.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 261.000000 && value <= 589.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 589.000000 && value <= 1151.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1151.000000 && value <= 1754.000000) {
            style = [ new ol.style.Style({
